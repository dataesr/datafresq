  ...
  return (
    <div>
      ...
      <p className='fr-mb-6w'>
        Bienvenue dans le guide d'utilisation de DataFresq. Cette documentation vous accompagne
        dans la prise en main de la plateforme, de la recherche de formations à la création
      ...
      <AutoGrid min={400} gap="lg" className="fr-mb-12w">
        {sections.map((section) => (
          <div key={section.href} className="fx-card fx-card--shadow fx-card--sm fx-card--lift fr-enlarge-link">
            <div className="fx-flex fx-gap-4w">
              <div>

                {section.icon && (
                  <div className={`icon-box ${section.icon}`} aria-hidden="true" />
                )}
              </div>
              <div>
