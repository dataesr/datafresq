...
Les onglets désactivés (grisés) indiquent qu'aucune donnée n'est disponible pour cette
section. Cela peut arriver pour plusieurs raisons :

- La formation est récente et les données ne sont pas encore disponibles
- La formation n'est pas couverte par la source de données concernée
- L'appariement entre la formation et la base de données n'a pas pu être établi

Pour comprendre en détail pourquoi certaines données peuvent être absentes, consultez la
page [Indicateurs — Données manquantes](/guide/indicateurs#données-manquantes).
